...
impl AotCompiler {
    ...
    pub fn compile_file(&mut self, file_path: PathBuf, release: bool, output: Option<&str>) -> Result<(), String> {
...
"#, self.target_triple);
    ...
    fn compile_llvm_ir(&self, ir_file: &str, output_name: &str, release: bool) -> Result<(), String> {
