# COMPLETE TEST OF ALL BUILT-IN FUNCTIONS
# Every single function in the interpreter
...
test_count = test_count + 1
out(test_count, ". is_empty (empty):", is_empty([]))

test_count = test_count + 1
out(test_count, ". is_empty (not empty):", is_empty([1]))
...
test_count = test_count + 1
out(test_count, ". ceil:", ceil(3.2))

test_count = test_count + 1
out(test_count, ". floor:", floor(3.7))

test_count = test_count + 1
out(test_count, ". sin:", sin(0))

test_count = test_count + 1
out(test_count, ". cos:", cos(0))

test_count = test_count + 1
out(test_count, ". tan:", tan(0))

test_count = test_count + 1
out(test_count, ". clamp:", clamp(15, 0, 10))
